...
class Station:
    ...
    def __init__(self):
        self.station = 0
        self.station_capacity = 100
        self.station_status = 'empty'
        self.station_load = 0
        self.station_load_list = []
        self.station_load_list.append(self.station_load)
    ...
    class data_analyze:
        ...
        def usr_behavior_clf(self, data_path, analysis_start=1324):
            ...
            X[['reg_centsPerHr', 'sch_centsPerHr', 'sch_centsPerOverstayHr']] = imputer.fit_transform(
                X[['reg_centsPerHr',
                   'sch_centsPerHr',

...
def charger_station(env, input_df, run_time):
    ...
    ######################### Price getting ################
      ...
      # print("what is time: ", event['time'])
      # print("what is duration : ", event['duration'])
      # print("what is eneed:", event['e_need'])
      ...
      # j_flex.append(res['J'][0])
      # j_asap.append(res['J'][1])
      # j_leave.append(res['J'][2])
      #'j_flex', 'j_asap', 'j_leave'
      ...
      choice_function(asap_price, flex_price)

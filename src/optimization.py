...
class Parameters:
    """
    A class to hold the parameters of the ev charging station optimization.

    :param z0: ...
    :param v0: ...
    :param Ts: Time of use cost array
    :param base_tariff_overstay: ...
    :param eff: charger efficiency
    :param dcm_choices: list of possible choices for the discrete choice model
    :param soft_v_eta: softening equality constraint for v; to avoid numerical error
    :param opt_eps: ...
    """
    ...
    def __init__(self,
                 ...
                 Ts=0.25,
                 base_tariff_overstay=1.0,
                 TOU=np.ones((96,)),
                 eff=1,
                 dcm_choices=['charging with flexibility', 'charging asap', 'leaving without charging'],
                 soft_v_eta=1e-3,
                 opt_eps=0.0001,
                 ):
        self.v0 = v0
        self.z0 = z0
        self.Ts = Ts
        self.base_tariff_overstay = base_tariff_overstay
        self.TOU = TOU
        self.eff = eff
        self.dcm_choices = dcm_choices
        self.soft_v_eta = soft_v_eta
...
class Problem:
    """
    A class containing variables for the charging optimization problem.
...
class Optimization:
    """
    A class to run the ev charging station optimization.
...
def optimizer_main(curr_time: int, departure_time: int, requested_energy: float, pwr_rate=6.6) -> tuple:
    ...
    INPUTS:
        ...
        * power_rate: constant value for the moment -> corresponds to max power accepted by vehicle.
